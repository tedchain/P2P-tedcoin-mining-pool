...
nets = dict(
    tedcoin=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://explorer.tedchain.network/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://explorer.tedchain.network/address/',
        TX_EXPLORER_URL_PREFIX='http://explorer.tedchain.network/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.01e6,
    ),
    tedcoin_testnet=math.Object(
        ...
        TX_EXPLORER_URL_PREFIX='http://tedchain.network/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.01e6,
    ),
